...
import { View,Text,TextInput,FlatList,TouchableOpacity,Alert,Image,Pressable, Keyboard, Button} from "react-native";
...
export default function TransportSuggestion() {
    ...
    const INITIAL_REGION = { // KL as default
        latitude: 3.139,
        longitude: 101.6869,
        latitudeDelta: 0.05,
        longitudeDelta: 0.05,
    ...
    const fetchNearbyPlaces = async (type:string) => {
        ...
        type === "source"?(setSource(places),setShowDropdownSource(true)):(setDestinations(places),setShowDropdownDestination(true))
        } catch (error) {
    ...
    return (
        ...
        >
            <View className="flex-row justify-between">
                <Image className="size-8 mt-1 mr-1" source={{
                ...
                <TextInput
                    ...
                    onFocus={() => {setShowDropdownSource(true);setShowDropdownDestination(false);}
                    }
                />
                <View className="flex-initial">
                    <Pressable onPress={()=>{fetchNearbyPlaces("source"),setShowDropdownDestination(false)}}>
                            <Image className="size-8 mt-2 ml-1" source={{
        ...
        >
            <View className="flex-row ">            
                <Image className="size-8 mt-2 mr-1" source={{
                ...
                <TextInput
                    ...
                    onFocus={() => {setShowDropdownDestination(true);setShowDropdownSource(false);}}
                />
                <View className="flex-initial">
                    <Pressable onPress={()=>{fetchNearbyPlaces("destination"),setShowDropdownSource(false)}}>
                            <Image className="size-8 mt-2 ml-1" source={{
                                uri:"https://cdn-icons-png.flaticon.com/512/934/934640.png"}}/>
                        </Pressable>
                </View>
